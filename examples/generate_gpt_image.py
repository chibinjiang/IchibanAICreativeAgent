...
from ai_creative_sdk.providers.openai_image.provider import OpenAIImageProvider
from ai_creative_sdk.skills.commercial_image import CommercialImageSkill


async def main():
    provider = OpenAIImageProvider(
        base_url='https://micas-ai.decimalpoint.com.cn/v1',
        api_key='sk-D99fKbk3cq7AyRImpNtZkotRcimEjhx7lGvHw1Fd4mcSjZBh',
    )
...
if __name__ == "__main__":
    """
    uv run -m examples.generate_gpt_image
    """
    asyncio.run(main())
